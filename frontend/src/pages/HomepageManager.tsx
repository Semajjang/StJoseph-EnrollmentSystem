  ...
  return (
    <div className="p-8 pb-24">
      <div className="flex flex-wrap items-end justify-between gap-4 mb-8">
        <div>
          <p className="text-xs uppercase tracking-[0.2em] font-bold text-blue-600 mb-2">
            Homepage Management
          </p>
          <h1 className="text-3xl font-bold text-slate-900">Manage Homepage Content</h1>
        ...
        <div className="flex flex-wrap gap-3">
          <button
            ...
            className="rounded-xl bg-white px-5 py-3 text-sm font-bold text-slate-700 shadow-sm border border-slate-200 hover:bg-slate-50"
          >
            Preview Homepage
          </button>
          <button
      ...
      {saveMessage ?
        <div className="mb-6 rounded-xl bg-[#EFF6FF] border border-sky-200 px-5 py-4 text-sm font-semibold text-blue-700">
          {saveMessage}
        </div> :
        null}
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1.15fr,0.85fr] gap-6">
        <div className="space-y-6">
          <section className="rounded-xl bg-white border border-slate-200 shadow-sm p-6">
            <h2 className="text-xl font-bold text-slate-900 mb-4">Hero Content</h2>
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <label className="block">
                <span className="text-sm font-bold text-slate-700">Eyebrow</span>
                <input
                  value={content.heroEyebrow}
                  onChange={(event) => setContent((prev) => ({ ...prev, heroEyebrow: event.target.value }))}
                  className="mt-2 w-full rounded-xl border border-slate-200 px-4 py-3 text-sm text-slate-900 outline-none focus:border-blue-500"
                />
              </label>
              <label className="block">
                <span className="text-sm font-bold text-slate-700">Hero Title</span>
                <input
            ...
            <label className="block mt-4">
              <span className="text-sm font-bold text-slate-700">Hero Description</span>
              <textarea
            ...
            <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-[180px,1fr]">
              <div>
                {content.heroImageUrl ?
                  <img src={content.heroImageUrl} alt="Homepage banner" className="h-32 w-full rounded-xl object-cover" /> :
                  <div className="h-32 w-full rounded-xl bg-gradient-to-r from-blue-400 to-blue-700" />}
                <label className="mt-3 inline-flex cursor-pointer rounded-full bg-white px-4 py-2 text-xs font-bold text-slate-700 shadow-sm border border-slate-200 hover:bg-slate-50">
                  Upload Banner
                  <input
                    type="file"
                    accept="image/*"
              ...
              <div className="rounded-xl bg-slate-50 border border-blue-100 p-4">
                <p className="text-sm font-bold text-slate-700 mb-2">Banner Image</p>
          ...
          <section className="rounded-xl bg-white border border-slate-200 shadow-sm p-6">
            <div className="flex items-center justify-between gap-3 mb-4">
              <div>
                <h2 className="text-xl font-bold text-slate-900">Highlight Cards</h2>
                <p className="text-sm text-slate-500">Update the featured homepage cards and upload images.</p>
              </div>
            </div>
            <div className="space-y-5">
              {content.highlights.map((highlight, index) => (
                <div
                  ...
                  className="rounded-xl border border-slate-200 bg-slate-50 p-5 cursor-move"
                >
                  <p className="text-xs uppercase tracking-wide font-bold text-slate-400 mb-3">
                    Card {index + 1} · Drag to reorder
                  </p>
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-[120px,1fr]">
                    <div>
                      {highlight.imageUrl ?
                        <img src={highlight.imageUrl} alt={highlight.title} className="h-28 w-full rounded-xl object-cover" /> :
                        <div className="h-28 w-full rounded-xl bg-gradient-to-r from-sky-300 to-blue-500" />}
                      <label className="mt-3 inline-flex cursor-pointer rounded-full bg-white px-4 py-2 text-xs font-bold text-slate-700 shadow-sm border border-slate-200 hover:bg-slate-50">
                        Upload Image
                        <input
                          type="file"
        ...
        <div className="space-y-6">
          <section className="rounded-xl bg-white border border-slate-200 shadow-sm p-6">
            ...
            <div className="space-y-4">
              ...
              <label className="block">
                <span className="text-sm font-bold text-slate-700">Intro Text</span>
                <textarea
              ...
              <button
                ...
                className="w-full rounded-xl border border-dashed border-sky-300 bg-slate-50 px-5 py-4 text-sm font-bold text-blue-700 hover:bg-[#EFF6FF]"
              >
                Add Announcement
              </button>
            </div>
          ...
          <section className="rounded-xl bg-white border border-slate-200 shadow-sm p-6">
            <h2 className="text-xl font-bold text-slate-900 mb-4">Portal Sections</h2>
            <div className="space-y-4">
              <label className="block">
              ...
              <label className="block">
                <span className="text-sm font-bold text-slate-700">Flow Description</span>
                <textarea
              ...
              <label className="block">
                <span className="text-sm font-bold text-slate-700">Quick Action Title</span>
                <input
              ...
              <label className="block">
                <span className="text-sm font-bold text-slate-700">Quick Action Description</span>
                <textarea
