  ...
  if (enrollments.length === 0) {
    return (
      <div className="p-8 flex flex-col items-center justify-center min-h-[60vh] text-center">
        ...
        <h2 className="text-2xl font-bold text-slate-900 mb-2">No Child Record Yet</h2>
            ...
            >
              <div className="flex flex-wrap items-start justify-between gap-4 mb-6">
                <div className="space-y-1">
                  ...
                  <p className="text-slate-500 font-semibold">{enrollment.program}</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="rounded-xl border border-blue-100 bg-slate-50 p-4">
                  <p className="text-xs uppercase tracking-wide text-slate-500 font-bold mb-1">Current Section</p>
                  <p className="text-2xl font-bold text-slate-900">{sectionLabel}</p>
                </div>
                <div className="rounded-xl border border-blue-100 bg-slate-50 p-4">
                  <p className="text-xs uppercase tracking-wide text-slate-500 font-bold mb-1">Schedule</p>
                  <p className="text-2xl font-bold text-slate-900">{schedule || 'Not assigned yet'}</p>
                  <p className="text-sm font-semibold text-slate-500 mt-1">{scheduleTimeLabel}</p>
                </div>
              </div>
            </motion.div>
          );
